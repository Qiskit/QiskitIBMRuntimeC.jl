...
This package allows you to execute circuits on a quantum computer from the [Julia programming language](https://julialang.org/) using the Qiskit IBM Runtime service.  It supports macOS and Linux and is perhaps the simplest way to submit circuits to hardware via the [Qiskit C API](https://quantum.cloud.ibm.com/docs/en/api/qiskit-c).  It builds on [Qiskit.jl](https://github.com/Qiskit/Qiskit.jl) and provides a lightweight Julia wrapper of the [qiskit-ibm-runtime-c](https://github.com/Qiskit/qiskit-ibm-runtime-c) client.
